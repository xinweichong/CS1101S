...
function filtered_accumulate(combiner, null_value, filter, term, a, next, b) {
    return a > b
           ? null_value
           : filter(a) 
             ? combiner(term(a), filtered_accumulate(combiner, null_value, term, next(a), next, b))
             : filtered_accumulate(combiner, null_value, term, next(a), next, b);
}
